...
//       if(userData.username < 5 || userData.password < 8 )

//         {
//               res.redirect('/register?error= Username should contain 5 or more character')
...
//         else
//         {
//       const newUser =  User.create({username: userData.username, password: userData.password})
//       console.log(newUser)
...
//     {
//     res.redirect('/register?error=User validation failed')
//     return
//     }
